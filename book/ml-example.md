...
```bash
pixi init ~/reproducible-cuda-scipy-2026/ml-example
cd ~/reproducible-cuda-scipy-2026/ml-example
```
```
✔ Created /home/<username>/reproducible-cuda-scipy-2026/ml-example/pixi.toml
```
